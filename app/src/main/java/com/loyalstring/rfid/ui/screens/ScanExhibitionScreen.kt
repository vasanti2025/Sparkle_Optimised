...
//@Composable
//fun ScanExhibitionScreen(onBack: () -> Unit, navController: NavHostController) {
...
//
//    val selectedExhibitios =
//        navController.previousBackStackEntry?.savedStateHandle?.get<List<BranchModel>>("selectedExhibition")
//            ?: emptyList()
//
//    val filteredByBranchItems by remember(allItems, selectedExhibitios) {
//        derivedStateOf {
//            if (selectedExhibitios.isEmpty()) allItems
//            else allItems.filter { item -> selectedExhibitios.any { it.BranchName == item.branchName } }
//        }
//    }
//
//
