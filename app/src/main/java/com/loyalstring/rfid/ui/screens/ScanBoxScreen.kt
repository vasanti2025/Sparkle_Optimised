...
//@Composable
//fun ScanBoxScreeen(onBack: () -> Unit, navController: NavHostController) {
...
//
//    val selectedBoxes =
//        navController.previousBackStackEntry?.savedStateHandle?.get<List<BoxModel>>("selectedBoxes")
//            ?: emptyList()
//
//    val filteredByBoxItems by remember(allItems, selectedBoxes) {
//        derivedStateOf {
//            if (selectedBoxes.isEmpty()) allItems
//            else allItems.filter { item -> selectedBoxes.any { it.BoxName == item.boxName } }
//        }
//    }
//
//
...
//    ) {
//        filteredByBoxItems.filter { item ->
...
//                            if (!firstPress) {
//                                firstPress = true
//                                if (selectedCategories.isNotEmpty() || selectedProducts.isNotEmpty() || selectedDesigns.isNotEmpty()) {
