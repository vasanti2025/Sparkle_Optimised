...
//@Composable
//fun ScanCounterScreen(onBack: () -> Unit, navController: NavHostController) {
...
//
//    val selectedCounters =
//        navController.previousBackStackEntry?.savedStateHandle?.get<List<CounterModel>>("selectedCounters")
//            ?: emptyList()
//
//    val filteredByCounterItems by remember(allItems, selectedCounters) {
//        derivedStateOf {
//            if (selectedCounters.isEmpty()) allItems
//            else allItems.filter { item -> selectedCounters.any { it.CounterName == item.counterName } }
//        }
//    }
//
//
...
//        filteredByCounterItems,
//        selectedCategoriesState,
//        selectedProductsState,
//        selectedDesignsState
//    ) {
//        filteredByCounterItems.filter { item ->
